...
func (s *ComplianceService) Name() string { return "compliance-service" }

// Dependencies returns service dependencies
func (s *ComplianceService) Dependencies() []string {
	return []string{"vault", "identity-service"}
}
...
func (s *ComplianceService) Start(ctx context.Context) error {
	s.ctx = ctx
	return nil
}

func (s *ComplianceService) Stop(ctx context.Context) error {
	return nil
}
