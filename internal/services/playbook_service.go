...
func (s *PlaybookService) Name() string { return "playbook-service" }

// Dependencies returns service dependencies
func (s *PlaybookService) Dependencies() []string {
	return []string{}
}

func (s *PlaybookService) Start(ctx context.Context) error {
	return nil
}

func (s *PlaybookService) Stop(ctx context.Context) error {
	return nil
}
