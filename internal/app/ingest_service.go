...
func (s *IngestService) Name() string { return "IngestService" }
...
// Startup initializes background workers (the pipeline processes the queue)
func (s *IngestService) Startup(ctx context.Context) {
...
// Shutdown gracefully stops the listeners and flushes the pipeline buffers
