...
func (s *NetworkIsolatorService) Name() string { return "NetworkIsolatorService" }

func (s *NetworkIsolatorService) Startup(ctx context.Context) {
	s.ctx = ctx
...
func (s *NetworkIsolatorService) Shutdown() {
