...
func (s *SIEMService) Startup(ctx context.Context) {
	s.ctx = ctx
	...
	s.bus.Subscribe("session.shared", func(e eventbus.Event) {
		// Log sharing events
	...
	s.bus.Subscribe("fido2.registration_completed", func(e eventbus.Event) {
