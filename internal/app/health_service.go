...
func (s *HealthService) Name() string { return "HealthService" }

// NewHealthService creates a new HealthService
func NewHealthService(log *logger.Logger, bus *eventbus.Bus, hc *monitoring.HealthChecker) *HealthService {
	s := &HealthService{
...
func (s *HealthService) Startup(ctx context.Context) {
	s.ctx = ctx
...
// GetAllHealth returns the health of all monitored hosts
func (s *HealthService) GetAllHealth() map[string]monitoring.HostHealth {
	if s.healthChecker == nil {
		return nil
	}
