<!-- OBLIVRA Web — AppLogo (Svelte 5) -->
<script lang="ts">
  interface Props { size?: number; class?: string; }
  let { size = 32, class: cls = '' }: Props = $props();
</script>

<svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class={cls}>
